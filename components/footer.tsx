  ...
  return (
    <footer className="relative w-full overflow-x-clip bg-linear-to-t pt-15 pb-10 bg-[#05091D]">
      <Image 
        ...
        className="absolute -top-4/6 lg:-top-full left-1/2 w-[calc(150vw)] -translate-x-1/2 opacity-80"
      />
      ...
      <div className="absolute bottom-10 w-full h-full overflow-clip z-1">
        <Image
            ...
            className="z-1 h-[calc(110%)] w-full object-cover object-top opacity-30"
          />
      ...
      <div className="relative z-10 mx-15 flex flex-col items-center justify-center gap-8">
        ...
        <p
          className={`text-light max-w-2xl text-center text-xl tracking-[0.3rem] text-white/80`}
        >
